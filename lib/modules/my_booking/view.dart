                              ...
                              children: List.generate(
                                ...
                                if (!showEmptyScreen &&
                                  ...
                                  DateTime dt = (snapshot.data!.docs[index]
                                      ...
                                      .toDate();
                                   var orderReference=   snapshot.data!.docs[index].get('orderReference').toString();
                                  return Padding(
                                                          ...
                                                          child:
                                                            ...
                                                            padding: const EdgeInsets
                                                                .fromLTRB(
                                                                    ...
                                                                    0,
                                                                    10),
                                                            child: orderReference.isNotEmpty? GestureDetector(
                                                              onTap: (){
                                                                FirebaseFirestore.instance.collection('orders').doc(orderReference).get().then((value){
                                                                    Get.to(OrderDetailPage(orderModel: value,));
                                                                });
                                                              },
                                                                child: Center(
                                                                  child: Text(
